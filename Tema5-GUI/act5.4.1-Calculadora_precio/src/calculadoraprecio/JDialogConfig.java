...
public class JDialogConfig extends javax.swing.JDialog {
     ...
     * @param discount
     */
    public JDialogConfig(java.awt.Frame parent, boolean modal, double tax, double discount) {
        super(parent, modal);
        this.tax = tax;
        this.discount = discount;
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextFieldIVA.setText(String.valueOf(tax));
    ...
    private void jButtonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAceptarActionPerformed
        ...
        try {
            tax = Double.parseDouble(jTextFieldIVA.getText());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogConfig.class.getName()).log(
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogConfig dialog = new JDialogConfig(new javax.swing.JFrame(), true, 21, 0);
